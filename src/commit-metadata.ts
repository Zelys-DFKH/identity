...
export function hasAICommitMetadata(message: string | undefined | null): boolean {
...
export function analyzeCommitMetadata(commits: GitHubCommit[]): CommitMetadataStats {
  ...
  return { totalCommits, aiCommits, ratio };
}
