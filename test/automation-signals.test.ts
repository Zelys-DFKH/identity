...
import { makeEvent, makeProfile } from "./helpers/make-event";
...
describe("detectThinProfileBot", () => {
	...
	it("returns no flag when fewer than 4 thin profile indicators", () => {
		const profile = makeProfile({ followers: 100, name: "Alice Developer", bio: "Building stuff", company: "Acme", location: "NYC", blog: "https://example.com" });
